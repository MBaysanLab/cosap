from cosap import (DNAPipeline, Sorter, BamReader, Pipeline, PipelineRunner, 
                   GeneFusionCaller, FastqReader, MSICaller, BamReader, DNAPipelineInput,
                   Mapper, VariantCaller, MDUP, Recalibrator, Trimmer)


# Reading the fastq files
normal_fastqs = [FastqReader("./data/SRR7890851_1.fastq.gz", name="normal", read=1),
                 FastqReader("./data/SRR7890851_2.fastq.gz", name="normal", read=2)]

tumor_fastqs = [FastqReader("./data/SRR7890850_1.fastq.gz", name="tumor", read=1),
...
# Creating mappers
mapper_normal = Mapper(input_step=trimmer_normal, library="bwa", params={
                            "read_groups": {
                                "ID": "0",
                                "SM": "normal",
                                "PU": "0",
...
mapper_tumor = Mapper(input_step=trimmer_tumor, library="bwa",params={
                            "read_groups": {
                                "ID": "0",
                                "SM": "tumor",
                                "PU": "0",
