...
from ._elprep_haplotypecaller_variancaller import ElprepHaplotypecaller
...
class VariantCallerFactory:
    ...
    ELPREP_HAPLOTYPECALLER = "elprep_haplotypecaller"
    ...
    def create(cls, caller_type: str) -> _VariantCaller:
        ...
        elif caller_type == cls.ELPREP_HAPLOTYPECALLER:
            return ElprepHaplotypecaller
        else:
