...
class FileFormats:
    ...
    CALIBRATED_INDEXING_OUTPUT: str = (
        "calibrated_indexed_{identification}.bam"
    )

    GATK_UNFILTERED_OUTPUT: str = "all_{germline_identification}_{tumor_identification}.vcf"
    GATK_SNP_OUTPUT: str = "snp_{germline_identification}_{tumor_identification}.vcf"
    GATK_INDEL_OUTPUT: str = "indel_{germline_identification}_{tumor_identification}.vcf"
    GATK_OTHER_VARIANTS_OUTPUT: str = "other_variants_{germline_identification}_{tumor_identification}.vcf"
